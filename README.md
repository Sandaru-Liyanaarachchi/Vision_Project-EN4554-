...
| `02_SAM_FineTune_Final.ipynb` | **Optimization:** Implements a training loop to fine-tune the lightweight `ViT-B` decoder on a subset of the COCO 2017 dataset, improving segmentation quality on complex objects. |
